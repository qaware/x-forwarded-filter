...
//		UriComponents after = new UriComponentsBuilder().uriComponents(before).build();
...
//		UriComponentsBuilder builder = new UriComponentsBuilder().pathSegment("foo").pathSegment("bar");
//		UriComponents result = builder.build();
//
//		assertEquals("/foo/bar", result.getPath());
//		assertEquals(Arrays.asList("foo", "bar"), result.getPathSegments());
...
//		UriComponentsBuilder builder = new UriComponentsBuilder().pathSegment("foo").path("/");
//		UriComponents result = builder.build();
//
//		assertEquals("/foo/", result.getPath());
...
//		UriComponentsBuilder builder = new UriComponentsBuilder().pathSegment("", "foo", "", "bar");
//		UriComponents result = builder.build();
//
//		assertEquals("/foo/bar", result.getPath());
//		assertEquals(Arrays.asList("foo", "bar"), result.getPathSegments());
...
//		UriComponentsBuilder builder = new UriComponentsBuilder().queryParam("baz", "qux", 42);
//		builder.replaceQueryParam("baz", "xuq", 24);
//		UriComponents result = builder.build();
//
//		assertEquals("baz=xuq&baz=24", result.getQuery());
//
//		builder = new UriComponentsBuilder().queryParam("baz", "qux", 42);
...
//		UriComponentsBuilder builder1 = new UriComponentsBuilder();
