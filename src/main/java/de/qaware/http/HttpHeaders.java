...
public class HttpHeaders implements Map<String, List<String>> {
	...
	public void setContentType(/*@Nullable*/ MediaType mediaType) {
		if (mediaType != null) {
			Validate.isTrue(!mediaType.isWildcardType(), "'Content-Type' cannot contain wildcard type '*'");
			Validate.isTrue(!mediaType.isWildcardSubtype(), "'Content-Type' cannot contain wildcard subtype '*'");
