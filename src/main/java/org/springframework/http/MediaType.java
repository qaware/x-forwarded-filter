...
public class MediaType extends MimeType implements Serializable {
	...
	public static final String MEDIA_TYPES_MUST_NOT_BE_NULL = "'mediaTypes' must not be null";
	...
	public static void sortBySpecificity(List<MediaType> mediaTypes) {
		AssertM.notNull(mediaTypes, MEDIA_TYPES_MUST_NOT_BE_NULL);
